...
#define LOAD_8x32(in00, in01, in02, in03, in10, in11, in12, in13, in20, in21, \
                  in22, in23, in30, in31, in32, in33, in40, in41, in42, in43, \
                  in50, in51, in52, in53, in60, in61, in62, in63, in70, in71, \
                  in72, in73, offset)                                         \
  /* load the first row from the 8x32 block*/                                 \
  in00 = vec_vsx_ld(offset, input);                                           \
  in01 = vec_vsx_ld(offset + 16, input);                                      \
  in02 = vec_vsx_ld(offset + 2 * 16, input);                                  \
  in03 = vec_vsx_ld(offset + 3 * 16, input);                                  \
                                                                              \
  in10 = vec_vsx_ld(offset + 4 * 16, input);                                  \
  in11 = vec_vsx_ld(offset + 5 * 16, input);                                  \
  in12 = vec_vsx_ld(offset + 6 * 16, input);                                  \
  in13 = vec_vsx_ld(offset + 7 * 16, input);                                  \
                                                                              \
  in20 = vec_vsx_ld(offset + 8 * 16, input);                                  \
  in21 = vec_vsx_ld(offset + 9 * 16, input);                                  \
  in22 = vec_vsx_ld(offset + 10 * 16, input);                                 \
  in23 = vec_vsx_ld(offset + 11 * 16, input);                                 \
                                                                              \
  in30 = vec_vsx_ld(offset + 12 * 16, input);                                 \
  in31 = vec_vsx_ld(offset + 13 * 16, input);                                 \
  in32 = vec_vsx_ld(offset + 14 * 16, input);                                 \
  in33 = vec_vsx_ld(offset + 15 * 16, input);                                 \
                                                                              \
  in40 = vec_vsx_ld(offset + 16 * 16, input);                                 \
  in41 = vec_vsx_ld(offset + 17 * 16, input);                                 \
  in42 = vec_vsx_ld(offset + 18 * 16, input);                                 \
  in43 = vec_vsx_ld(offset + 19 * 16, input);                                 \
                                                                              \
  in50 = vec_vsx_ld(offset + 20 * 16, input);                                 \
  in51 = vec_vsx_ld(offset + 21 * 16, input);                                 \
  in52 = vec_vsx_ld(offset + 22 * 16, input);                                 \
  in53 = vec_vsx_ld(offset + 23 * 16, input);                                 \
                                                                              \
  in60 = vec_vsx_ld(offset + 24 * 16, input);                                 \
  in61 = vec_vsx_ld(offset + 25 * 16, input);                                 \
  in62 = vec_vsx_ld(offset + 26 * 16, input);                                 \
  in63 = vec_vsx_ld(offset + 27 * 16, input);                                 \
                                                                              \
  /* load the last row from the 8x32 block*/                                  \
  in70 = vec_vsx_ld(offset + 28 * 16, input);                                 \
  in71 = vec_vsx_ld(offset + 29 * 16, input);                                 \
  in72 = vec_vsx_ld(offset + 30 * 16, input);                                 \
  in73 = vec_vsx_ld(offset + 31 * 16, input);
...
void vpx_idct32x32_1024_add_vsx(const tran_low_t *input, uint8_t *dest,
  ...
  LOAD_8x32(src0[0][0], src0[1][0], src0[2][0], src0[3][0], src0[0][1],
            src0[1][1], src0[2][1], src0[3][1], src0[0][2], src0[1][2],
            src0[2][2], src0[3][2], src0[0][3], src0[1][3], src0[2][3],
            src0[3][3], src0[0][4], src0[1][4], src0[2][4], src0[3][4],
            src0[0][5], src0[1][5], src0[2][5], src0[3][5], src0[0][6],
            src0[1][6], src0[2][6], src0[3][6], src0[0][7], src0[1][7],
            src0[2][7], src0[3][7], 0);
  // Rows
  ...
  LOAD_8x32(src1[0][0], src1[1][0], src1[2][0], src1[3][0], src1[0][1],
            src1[1][1], src1[2][1], src1[3][1], src1[0][2], src1[1][2],
            src1[2][2], src1[3][2], src1[0][3], src1[1][3], src1[2][3],
            src1[3][3], src1[0][4], src1[1][4], src1[2][4], src1[3][4],
            src1[0][5], src1[1][5], src1[2][5], src1[3][5], src1[0][6],
            src1[1][6], src1[2][6], src1[3][6], src1[0][7], src1[1][7],
            src1[2][7], src1[3][7], 512);
  TRANSPOSE_8x32(src1, tmp);
  IDCT32(tmp[0], tmp[1], tmp[2], tmp[3], src1);
  TRANSPOSE_8x32(tmp, src1);

  LOAD_8x32(src2[0][0], src2[1][0], src2[2][0], src2[3][0], src2[0][1],
            src2[1][1], src2[2][1], src2[3][1], src2[0][2], src2[1][2],
            src2[2][2], src2[3][2], src2[0][3], src2[1][3], src2[2][3],
            src2[3][3], src2[0][4], src2[1][4], src2[2][4], src2[3][4],
            src2[0][5], src2[1][5], src2[2][5], src2[3][5], src2[0][6],
            src2[1][6], src2[2][6], src2[3][6], src2[0][7], src2[1][7],
            src2[2][7], src2[3][7], 1024);
  TRANSPOSE_8x32(src2, tmp);
  IDCT32(tmp[0], tmp[1], tmp[2], tmp[3], src2);
  TRANSPOSE_8x32(tmp, src2);

  LOAD_8x32(src3[0][0], src3[1][0], src3[2][0], src3[3][0], src3[0][1],
            src3[1][1], src3[2][1], src3[3][1], src3[0][2], src3[1][2],
            src3[2][2], src3[3][2], src3[0][3], src3[1][3], src3[2][3],
            src3[3][3], src3[0][4], src3[1][4], src3[2][4], src3[3][4],
            src3[0][5], src3[1][5], src3[2][5], src3[3][5], src3[0][6],
            src3[1][6], src3[2][6], src3[3][6], src3[0][7], src3[1][7],
            src3[2][7], src3[3][7], 1536);
