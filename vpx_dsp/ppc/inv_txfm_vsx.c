...
#define IDCT16(in0, in1, in2, in3, in4, in5, in6, in7, in8, in9, inA, inB,     \
  ...
  outF = vec_add(inE, inF);                                                    \
                                                                               \
  /* stage 4 */                                                                \
  STEP8_1(out0, out1, in1, in0, cospi16_v);                                    \
  ...
  out4 = in4;                                                                  \
  STEP8_1(in6, in5, out5, out6, cospi16_v);                                    \
  out7 = in7;                                                                  \
                                                                               \
  ...
  in8 = out8;                                                                  \
  in9 = out9;                                                                  \
  STEP8_1(outD, outA, inA, inD, cospi16_v);                                    \
  STEP8_1(outC, outB, inB, inC, cospi16_v);                                    \
  inE = outE;                                                                  \
  inF = outF;                                                                  \
                                                                               \
  /* stage 7 */                                                                \
